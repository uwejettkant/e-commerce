    ...
    <main>
      ...
      {categories.map((category) => (
        <Card key={category._id}>
          {category.id === 1 &&
          <img src={Jeansm} alt="jeans male" />}
          {category.id === 2 &&
          <img src={Jeansw} alt="jeans female" />}
          {category.id === 3 &&
          <img src={Shirtm} alt="shirts male" />}
          {category.id === 4 &&
          <img src={Shirtw} alt="shirts female" />}
          {category.id === 5 &&
          ...
          <ButtonStyled>See Products</ButtonStyled>
        </Card>
      ))}
      </CenteredContainer>
    </main>
